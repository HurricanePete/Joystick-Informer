	...
	return (
		<footer className="col-12">
			<div className="col-3 tc clear-float center pt4 white">
				...
				<ul>
					<li className="dib"><a href="https://github.com/HurricanePete" target="_blank" rel="noopener noreferrer"><i className="fab fa-github-square fa-2x"></i></a></li>
					<li className="dib"><a href="https://www.linkedin.com/in/zachary-pete-78131a94" target="_blank" rel="noopener noreferrer"><i className="fab fa-linkedin fa-2x"></i></a></li>
				</ul>
